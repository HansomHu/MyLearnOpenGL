...
int main() {
    ...
    const std::string lightVshFile = std::string(GLSL_ROOT_DIR) + "/lighting/diffuse/light.vsh";
    const std::string lightFshFile = std::string(GLSL_ROOT_DIR) + "/lighting/diffuse/light.fsh";
    Shader lightShader(lightVshFile.c_str(), lightFshFile.c_str());

    const std::string objectVshFile = std::string(GLSL_ROOT_DIR) + "/lighting/diffuse/object.vsh";
    const std::string objectFshFile = std::string(GLSL_ROOT_DIR) + "/lighting/diffuse/object.fsh";
