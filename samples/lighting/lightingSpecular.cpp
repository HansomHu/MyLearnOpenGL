...
int main() {
    ...
    const std::string objectVshFile = std::string(GLSL_ROOT_DIR) + "/lighting/specular/object.vsh";
    const std::string objectFshFile = std::string(GLSL_ROOT_DIR) + "/lighting/specular/object.fsh";
