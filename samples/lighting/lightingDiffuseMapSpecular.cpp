...
int main() {
    ...
    const std::string lightVshFile = std::string(GLSL_ROOT_DIR) + "/lighting/specular/light.vsh";
    const std::string lightFshFile = std::string(GLSL_ROOT_DIR) + "/lighting/specular/light.fsh";
    Shader lightShader(lightVshFile.c_str(), lightFshFile.c_str());

    const std::string objectVshFile = std::string(GLSL_ROOT_DIR) + "/lighting/map_specular/object.vsh";
    const std::string objectFshFile = std::string(GLSL_ROOT_DIR) + "/lighting/map_specular/object.fsh";
    ...
    unsigned char* image = stbi_load((resourceDir + "/textures/container2.png").c_str(), &width, &height, &channel, 0);
    ...
    unsigned char* image1 =
        stbi_load((resourceDir + "/textures/container2_specular.png").c_str(), &width, &height, &channel, 0);
